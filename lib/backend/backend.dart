...
import 'schema/libraries_record.dart';
...
export 'schema/libraries_record.dart';
...
/// Functions to query LibrariesRecords (as a Stream and as a Future).
Future<int> queryLibrariesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      LibrariesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<LibrariesRecord>> queryLibrariesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LibrariesRecord.collection,
      LibrariesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<LibrariesRecord>> queryLibrariesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
