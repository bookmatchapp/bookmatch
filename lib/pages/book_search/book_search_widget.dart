...
import 'book_search_model.dart';
export 'book_search_model.dart';
...
class _BookSearchWidgetState extends State<BookSearchWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookSearchModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BooksRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BooksRecord> bookSearchBooksRecordList = snapshot.data!;
                        ...
                        if (!FFAppState().searchMode)
                          Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final allBooks =
                                    bookSearchBooksRecordList.toList();
                                if (allBooks.isEmpty) {
                                  return Center(
                                    child: Image.asset(
                                                ...
                                                Padding(
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child: FavoriteButtonWidget(
                                                      key: Key(
                                                        'Key6wv_${allBooksItem.reference.id}',
                                                      ),
                                                      selected: functions
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child: FavoriteButtonWidget(
                                                      key: Key(
                                                        'Keyhro_${searchResultsItem.reference.id}',
                                                      ),
                                                      selected: functions
                                                          .checkIfBookIsInTheFavorites(
                                                              searchResultsItem
