...
class _LibraryCreateEditWidgetState extends State<LibraryCreateEditWidget>
  ...
  void initState() {
    ...
    _model.descriptionTextController ??=
        TextEditingController(text: widget.library?.description);
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.lFormValidation = true;
                          if (_model.formKey.currentState == null ||
                              !_model.formKey.currentState!.validate()) {
                            _model.lFormValidation = false;
                          }
                          if (_model.lFormValidation!) {
                            if (widget.library != null) {
                              await widget.library!.reference
                                  .update(createLibrariesRecordData(
