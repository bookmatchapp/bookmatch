...
class _BookListWidgetState extends State<BookListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookListModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BooksRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BooksRecord> bookListBooksRecordList = snapshot.data!;
                    ...
                    children: [
                      if (!FFAppState().searchMode)
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final allBooks = bookListBooksRecordList.toList();
                              if (allBooks.isEmpty) {
                                return Center(
                                  child: Image.asset(
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              title: const Text(
                                                                  'Delete Book'),
                                                              content: Text(
                                                                  'Are you sure you want to delete ${allBooksItem.title}?'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              title: const Text(
                                                                  'Delete Book'),
                                                              content: Text(
                                                                  'Are you sure you want to delete ${searchResultsItem.title}?'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
